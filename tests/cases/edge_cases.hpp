...
inline Expect acc(OrderId id) { return {EventType::Accepted, id, 0, kNoPrice, 0,
                                        RejectReason::None, CancelReason::None}; }
inline Expect fil(OrderId id) { return {EventType::Filled, id, 0, kNoPrice, 0,
                                        RejectReason::None, CancelReason::None}; }
